...
This Quarto extension enables the use of Font Awesome icons within Quarto documents using shortcodes. It supports standalone icons, icon-based lists, and custom styling options.
...
- `group`: Icon group (e.g., `solid`, `brands`, `regular`). Default is `solid`.
...
- `fa-li`: Adds an item with an icon from Font Awesome. (Optional styling attributes: `color`, `group`)
